...
const flightAttendantInfoButton = document.querySelector(
  ".flight-attendant-info"
);
const flightAttendantDataTextElement = document.querySelector(
  ".flight-attendant-data"
);
const groundAttendantInfoButton = document.querySelector(
  ".ground-attendant-info"
);
const groundAttendantDataTextElement = document.querySelector(
  ".ground-attendant-data"
);
...
const randomAirportStaffButton = document.querySelector(
  ".random-airport-staff-button"
);
const randomAirportStaffTextElement = document.querySelector(
...
const groundAttendantObj = new GroundAttendant(
  "Hila",
  "David",
  5,
  "Israel",
...
randomAirportStaffButton.addEventListener("click", () => {
  ...
  if (staffObj instanceof Passenger) {
    ...
    staffObj.displayData(
      randomAirportStaffTextElement,
      "flight-attendant",
      flightAttendantObj.department,
      flightAttendantObj.originCountry
    );
  } else if (staffObj instanceof GroundAttendant) {
    staffObj.displayData(
      randomAirportStaffTextElement,
      "ground-attendant",
      groundAttendantObj.role,

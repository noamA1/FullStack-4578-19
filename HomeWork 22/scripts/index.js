...
const spekerSwitchInputElement = (document.querySelector(".switch-speker-input"));
...
const limitedSpekerSwitchInputElement = (document.querySelector(".switch-limited-speker-input"));
const limitedSpekerSwitchLabelElement = document.querySelector(".switch-limited-speker-label");
const limitedSpekerOneButtonElement = document.querySelector(".limited-speker-one");
const limitedSpekerTwoButtonElement = document.querySelector(".limited-speker-two");
let currentLimitedSpeker;
...
// #3: Flashlight
const flashlightReplaceBatteriesButton = document.querySelector(".flashlight-replaceBatteries");
const flashlightInfoButton = document.querySelector(".flashlight-info");
const flashlightSwitchInputElement = (document.querySelector(".switch-flashlight-input"));
const flashlightSwitchLabelElement = document.querySelector(".switch-flashlight-label");
...
const limitedFlashlightReplaceBatteriesButton = document.querySelector(".limited-flashlight-replaceBatteries");
const limitedFlashlightInfoButton = document.querySelector(".limited-flashlight-info");
const limitedFlashlightSwitchInputElement = (document.querySelector(".switch-limited-flashlight-input"));
const limitedFlashlightSwitchLabelElement = document.querySelector(".switch-limited-flashlight-label");
const limitedFlashlightOneButtonElement = document.querySelector(".limited-flashlight-one");
const limitedFlashlightTwoButtonElement = document.querySelector(".limited-flashlight-two");
let currentLimitedFlashkight;
